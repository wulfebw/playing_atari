...
class DeepQLearner:
    ...
    def __init__(self, input_width, input_height, num_actions,
        ...
        self._train_autoencoder = theano.function([], [compression_loss], updates=compression_updates, 
                                        givens=givens)
        self._q_vals = theano.function([], q_vals, givens={states: self.states_shared})
        self._compression_loss = theano.function([], compression_loss, givens={states: self.states_shared})
    ...
    def train(self, states, actions, rewards, next_states, terminals):
        ...
        if (self.freeze_interval > 0 and
            ...
            self.reset_q_hat()
        loss, _ = self._train()
        compression_loss = self._train_autoencoder()
    ...
    def build_nature_network(self, input_width, input_height, output_dim,
        ...
        # compressor
        # how do these layers handle multiple batches?
